...
What are we aiming for? Imagine four dartboards. The shots on the first target are reliable, as they hit the same point repeatedly; however, the shots all miss the bulls-eye in the centre. This first target is therefore reliable, yet invalid. The second target shows validity, as the shots are centred around the bulls-eye; however, the shots are unreliable, spread across the entire breadth of the target. Moving on, the third target is neither valid nor reliable, as the shots are spread widely across the upper portion of the target. And then finally, the fourth target represents both reliability and validity; the shots consistently hit the bulls-eye in the target's centre.
